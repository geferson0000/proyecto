...
<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img class="bd-placeholder-img" src="Img/T-A.jpg" alt="Teatro-A" />
      <div class="container">
    ...
    <div class="carousel-item">
      <img class="bd-placeholder-img" src="Img/T-A1.jpg" alt="Teatro-A1" />
      <div class="container">
    ...
    <!-- 3 -->
    <div class="carousel-item">
      <img class="bd-placeholder-img" src="Img/T-A2.jpg" alt="Teatro-A2" />
      <div class="container">
